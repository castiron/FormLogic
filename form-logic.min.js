...
b,c,d,e,f,g;c=this.$el.data("show-if").toString().split(";");c=c.map(function(a){return a.trim()});b=this;f=this.parents;g=[];d=0;for(e=f.length;d<e;d++)a=f[d],g.push(a.change(function(){var a,d,e,f;if("checkbox"===b.parentType||"radio"===b.parentType){f=b.parents;d=0;for(e=f.length;d<e;d++)if(a=f[d],a.is(":checked")&&-1!==c.indexOf(a.val())){b.show();return}return b.hide()}return-1!==c.indexOf($(this).val())?b.show():b.hide()}).change());return g};j.prototype.setupShowIfAny=function(){var a,b,c,
d,e,f,g=this;if("radio"===this.parentType||"checkbox"===this.parentType){b=this;e=this.parents;f=[];c=0;for(d=e.length;c<d;c++)a=e[c],f.push(a.change(function(){var c,d,e,f;c=!1;f=b.parents;d=0;for(e=f.length;d<e;d++)a=f[d],a.is(":checked")&&(c=!0);return c?b.show():b.hide()}));return f}e=this.parents;f=[];c=0;for(d=e.length;c<d;c++)a=e[c],f.push(a.change(function(){return""!==a.val()?g.show():g.hide()}));return f};j.prototype.show=function(){var a,b,c,d,e,f;console.log("showing");this.$el.show().data("ignore-validation",
!1);e=this.$el.find("*");f=[];c=0;for(d=e.length;c<d;c++)a=e[c],(b=$(a).attr("name"))?(b=$('[data-depends-on="'+b+'"]'),0<b.length?f.push($(a).change()):f.push(void 0)):f.push(void 0);return f};j.prototype.hide=function(){var a,b,c,d,e;console.log("hiding");this.$el.data("ignore-validation",!0).hide();d=this.$el.find("*");e=[];b=0;for(c=d.length;b<c;b++)a=d[b],(a=$(a).attr("name"))?e.push($('[data-depends-on="'+a+'"]').data("ignore-validation",!0).hide()):e.push(void 0);return e};var h=function(a,
b){var c,d,e,f,g=this;this.options=b;this.$el=$(a);this.$submit=this.$el.find('input[type="submit"]');f=this.$el.find("input");d=0;for(e=f.length;d<e;d++)c=f[d],this.addHint($(c));this.$submit.click(function(){var a,b,d,e,f,h,j,k;h=g.$el.find(".hasError");b=0;for(f=h.length;b<f;b++)a=h[b],$(a).removeClass(".hasError");h=g.$el.find(".error");b=0;for(f=h.length;b<f;b++)a=h[b],$(a).html("");b=g.$el.find("input, select, textarea");f=0;for(h=b.length;f<h;f++)if(c=b[f],a=$(c),"submit"===a.attr("type"))g.$submit=
a;else if(a.hasClass("has-hint")&&a.val(""),!a.data("ignore-validation")&&(d=a.data("validate"),"string"===typeof d)){e=d.split(" ");k=0;for(j=e.length;k<j;k++)switch(d=e[k],d){case "required":g.validateRequired(a);break;case "email":g.validateEmail(a);break;case "minimum":g.validateMinimum(a);break;case "maximum":g.validateMaximum(a);break;case "number":g.validateNumber(a);break;case "confirm":g.validateConfirm(a)}}if(g.isValid()&&null!=l.onValidSubmit)return l.onValidSubmit();if(!g.isValid()){f=
g.$el.find("input");b=0;for(a=f.length;b<a;b++)c=f[b],g.addHint($(c));return!1}return!0})};h.prototype.validateRequired=function(a){var b,c,d,e;if("radio"===a.attr("type")||"checkbox"===a.attr("type")){b=a.attr("name");e=$('[name="'+b+'"]');c=0;for(d=e.length;c<d;c++)if(b=e[c],$(b).is(":checked"))return;return this.showError(a,"required")}if(""===a.val())return this.showError(a,"required")};h.prototype.validateEmail=function(a){var b;if(""!==a.val()&&(b=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
